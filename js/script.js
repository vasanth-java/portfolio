...
let progressangular = setInterval(() => {
  ...
  angularProgress.style.background = `conic-gradient(#0573f7 ${angularStartValue * 3.6}deg, #ededed 0deg)`;
...
let progressspring = setInterval(() => {
  ...
  springProgress.style.background = `conic-gradient(#10ff17 ${springStartValue * 3.6}deg, #ededed 0deg)`;
...
let progressmysql = setInterval(() => {
  ...
  mysqlProgress.style.background = `conic-gradient(#ba00f6 ${mysqlStartValue * 3.6}deg, #ededed 0deg)`;
